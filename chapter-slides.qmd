...
::: notes
We begin with the historical context - understanding why sulfonamides
were revolutionary and how they shaped modern antimicrobial therapy.
:::
...
# PART 2: Sulfonamide Chemistry and Structure {background-color="#b20e10"}
...
::: notes
The structural similarity to para-aminobenzoic acid (PABA) is the key to
understanding the mechanism of action. The free amino group at the
4-carbon position is essential for activity.
:::
...
::: notes
This pathway diagram is crucial for understanding how sulfonamides and
trimethoprim work together. Note the two sequential steps that are
blocked.
:::
...
::: notes
The combination of sulfonamide plus trimethoprim blocks two sequential
steps in the same pathway. This creates true synergy - the combination
is more effective than the sum of individual effects.
:::
...
below 20%. Fluoroquinolones or nitrofurantoin may be preferred.
:::
...
oral, well-tolerated, and usually effective. However, it lacks activity
against streptococci, so consider coverage gaps.
:::
...
::: notes
Pause for audience response. This is a straightforward indication for
PCP prophylaxis.
:::
...
::: notes
Pause for response. This highlights the importance of local resistance
patterns.
:::
...
::: notes
These are the fundamental concepts that should guide clinical use of
TMP-SMX.
:::
...
::: notes
This slide can serve as a quick clinical decision aid. TMP-SMX remains
highly valuable when used appropriately.
:::
...
::: notes
Open floor for questions. Be prepared to discuss specific clinical
scenarios or clarify any concepts covered in the lecture.
:::
